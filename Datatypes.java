    ...
    public static void main(String []argh)
    {
        ...
        for(int i=0;i<t;i++)
        {
            try
            {
                ...
                if(x>=java.lang.Math.pow(-2,31) && x<=(java.lang.Math.pow(2,31)-1))System.out.println("* int");
                if(x>=java.lang.Math.pow(-2,63) && x<=(java.lang.Math.pow(2,63)-1))System.out.println("* long");
                //Complete the code
            }
            catch(Exception e)
            {
